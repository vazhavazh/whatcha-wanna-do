	...
	return (
		<div className='flex items-center justify-center flex-col'>
			<div
				...
				<div
					className='text-3xl md:text-6xl bg-gradient-to-r from 
                    from-fuchsia-500 to-pink-600 text-white px-4 p-2 rounded-md 
                    pb-4'>
					work forward.
				</div>
			</div>
			...
			<Button
				...
				size='lg'
				asChild>
				<Link href='/sign-up'>Get Whatcha wanna do for free</Link>
			</Button>
		</div>
	);
};
